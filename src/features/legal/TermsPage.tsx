  ...
  return (
    <div className="px-4 py-10 max-w-2xl mx-auto" style={{ color: "var(--color-text)" }}>
      ...
      <p className="text-sm leading-relaxed mb-4" style={{ color: "var(--color-text-secondary)" }}>
        By accessing Market, you agree to these terms. If you do not agree, please do not use the service.
      </p>
      ...
      <p className="text-sm leading-relaxed mb-4" style={{ color: "var(--color-text-secondary)" }}>
        Market is provided "as is". We make no warranties regarding its availability or fitness for a particular purpose.
      </p>
